...
from zarrs_python.buffer import Buffer, BufferPrototype
from zarrs_python.common import OpenMode
from zarrs_python.store.core import _dereference_path
...
if TYPE_CHECKING:
    ...
    from zarrs_python.common import BytesLike
