...
from zarrs_python.buffer import Buffer, NDBuffer
from zarrs_python.chunk_grids import ChunkGrid
from zarrs_python.common import ChunkCoords, concurrent_map
...
if TYPE_CHECKING:
    ...
    from zarrs_python.indexing import SelectorTuple
...
class _Codec(Generic[CodecInput, CodecOutput], Metadata):
    ...
    Codecs can be registered via zarrs_python.codecs.registry.
    """
