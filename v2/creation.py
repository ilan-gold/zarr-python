...
from zarrs_python.v2.util import normalize_dimension_separator
...
def create(
    ...
    **kwargs,
    ...
    Create an array with default settings::
        ...
        >>> import zarrs_python
        >>> z = zarrs_python.v2.create((10000, 10000), chunks=(1000, 1000))
        >>> z
        <zarrs_python.v2.core.Array (10000, 10000) float64>

    Create an array with different some different configuration options::

        >>> from numcodecs import Blosc
        >>> compressor = Blosc(cname='zstd', clevel=1, shuffle=Blosc.BITSHUFFLE)
        >>> z = zarrs_python.v2.create((10000, 10000), chunks=(1000, 1000), dtype='i1', order='F',
        ...                 compressor=compressor)
        >>> z
        <zarrs_python.v2.core.Array (10000, 10000) int8>
    ...
    encoding, e.g., `MsgPack` or `Pickle` from `numcodecs`::
        ...
        >>> z = zarrs_python.v2.create((10000, 10000), chunks=(1000, 1000), dtype=object,
        ...                 object_codec=MsgPack())
        >>> z
        <zarrs_python.v2.core.Array (10000, 10000) object>
    ...
    Example with some filters, and also storing chunks separately from metadata::
        ...
        >>> z = zarrs_python.v2.create((10000, 10000), chunks=(1000, 1000), dtype='f8',
...
def empty(shape, **kwargs):
    ...
    For parameter definitions see :func:`zarrs_python.v2.creation.create`.
...
def zeros(shape, **kwargs):
    ...
    --------
    >>> import zarrs_python
    >>> z = zarrs_python.v2.zeros((10000, 10000), chunks=(1000, 1000))
    >>> z
    <zarrs_python.v2.core.Array (10000, 10000) float64>
    >>> z[:2, :2]
    array([[0., 0.],
...
def ones(shape, **kwargs):
    ...
    --------
    >>> import zarrs_python
    >>> z = zarrs_python.v2.ones((10000, 10000), chunks=(1000, 1000))
    >>> z
    <zarrs_python.v2.core.Array (10000, 10000) float64>
    >>> z[:2, :2]
    array([[1., 1.],
...
def full(shape, fill_value, **kwargs):
    ...
    --------
    >>> import zarrs_python
    >>> z = zarrs_python.v2.full((10000, 10000), chunks=(1000, 1000), fill_value=42)
    >>> z
    <zarrs_python.v2.core.Array (10000, 10000) float64>
    >>> z[:2, :2]
    array([[42., 42.],
...
def array(data, **kwargs):
    ...
    other parameter definitions see :func:`zarrs_python.v2.creation.create`.
    ...
    >>> z = zarrs_python.v2.array(a, chunks=(1000, 1000))
    >>> z
    <zarrs_python.v2.core.Array (10000, 10000) int64>
...
def open_array(
    ...
    **kwargs,
    ...
    >>> import numpy as np
    >>> import zarrs_python
    >>> z1 = zarrs_python.v2.open_array('data/example.zarr', mode='w', shape=(10000, 10000),
    ...                      chunks=(1000, 1000), fill_value=0)
    >>> z1[:] = np.arange(100000000).reshape(10000, 10000)
    >>> z1
    <zarrs_python.v2.core.Array (10000, 10000) float64>
    >>> z2 = zarrs_python.v2.open_array('data/example.zarr', mode='r')
    >>> z2
    <zarrs_python.v2.core.Array (10000, 10000) float64 read-only>
    >>> np.all(z1[:] == z2[:])
    True
