...
from zarrs_python.v2.meta import Metadata2
from zarrs_python.v2.util import normalize_storage_path
...
class BaseStore(MutableMapping[str, Any]):
    ...
    def _ensure_store(store: Any):
        ...
        """
        from zarrs_python.v2.storage import KVStore  # avoid circular import
        ...
        raise ValueError(
            ...
            f"wrap it in zarrs_python.v2.storage.KVStore. Got {store}"
        )
