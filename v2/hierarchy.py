...
class Group(MutableMapping[str, Any]):
    ...
    def __getitem__(self, item):
        ...
        >>> g1['foo']
        <zarrs_python.v2.hierarchy.Group '/foo'>
        >>> g1['foo/bar']
        <zarrs_python.v2.hierarchy.Group '/foo/bar'>
        >>> g1['foo/bar/baz']
        <zarrs_python.v2.core.Array '/foo/bar/baz' (100,) float64>
    ...
    def groups(self):
        ...
        ...     print(n, type(v))
        bar <class 'zarrs_python.v2.hierarchy.Group'>
        foo <class 'zarrs_python.v2.hierarchy.Group'>
    ...
    def arrays(self, recurse=False):
        ...
        ...     print(n, type(v))
        baz <class 'zarrs_python.v2.core.Array'>
        quux <class 'zarrs_python.v2.core.Array'>
    ...
    def visitvalues(self, func):
        ...
        <zarrs_python.v2.hierarchy.Group '/bar'>
        <zarrs_python.v2.hierarchy.Group '/bar/baz'>
        <zarrs_python.v2.hierarchy.Group '/bar/quux'>
        <zarrs_python.v2.hierarchy.Group '/foo'>
    ...
    def visititems(self, func):
        ...
        ('bar', <zarrs_python.v2.hierarchy.Group '/bar'>)
        ('bar/baz', <zarrs_python.v2.hierarchy.Group '/bar/baz'>)
        ('bar/quux', <zarrs_python.v2.hierarchy.Group '/bar/quux'>)
        ('foo', <zarrs_python.v2.hierarchy.Group '/foo'>)
        >>> g3.visititems(print_visitor)
        ('baz', <zarrs_python.v2.hierarchy.Group '/bar/baz'>)
        ('quux', <zarrs_python.v2.hierarchy.Group '/bar/quux'>)
    ...
    def create_group(self, name, overwrite=False):
        ...
        Returns
        -------
        g : zarrs_python.v2.hierarchy.Group
    ...
    def create_dataset(self, name, **kwargs):
        ...
        synchronizer : zarrs_python.v2.sync.ArraySynchronizer, optional
            Array synchronizer.
        ...
        ...                        chunks=(1000, 1000))
        >>> d1
        <zarrs_python.v2.core.Array '/foo' (10000, 10000) float64>
        >>> d2 = g1.create_dataset('bar/baz/qux', shape=(100, 100, 100),
        ...                        chunks=(100, 10, 10))
        >>> d2
        <zarrs_python.v2.core.Array '/bar/baz/qux' (100, 100, 100) float64>
    ...
    def require_dataset(self, name, shape, dtype=None, exact=False, **kwargs):
        ...
        Other `kwargs` are as per :func:`zarrs_python.v2.hierarchy.Group.create_dataset`.
    ...
    def create(self, name, **kwargs):
        ...
        :func:`zarrs_python.v2.creation.create`."""
    ...
    def empty(self, name, **kwargs):
        """Create an array. Keyword arguments as per
        :func:`zarrs_python.v2.creation.empty`."""
    ...
    def zeros(self, name, **kwargs):
        """Create an array. Keyword arguments as per
        :func:`zarrs_python.v2.creation.zeros`."""
    ...
    def ones(self, name, **kwargs):
        """Create an array. Keyword arguments as per
        :func:`zarrs_python.v2.creation.ones`."""
    ...
    def full(self, name, fill_value, **kwargs):
        """Create an array. Keyword arguments as per
        :func:`zarrs_python.v2.creation.full`."""
    ...
    def array(self, name, data, **kwargs):
        """Create an array. Keyword arguments as per
        :func:`zarrs_python.v2.creation.array`."""
    ...
    def empty_like(self, name, data, **kwargs):
        """Create an array. Keyword arguments as per
        :func:`zarrs_python.v2.creation.empty_like`."""
    ...
    def zeros_like(self, name, data, **kwargs):
        """Create an array. Keyword arguments as per
        :func:`zarrs_python.v2.creation.zeros_like`."""
    ...
    def ones_like(self, name, data, **kwargs):
        """Create an array. Keyword arguments as per
        :func:`zarrs_python.v2.creation.ones_like`."""
    ...
    def full_like(self, name, data, **kwargs):
        """Create an array. Keyword arguments as per
        :func:`zarrs_python.v2.creation.full_like`."""
...
def group(
    ...
    *,
    ...
    Create a group with a different store::
        ...
        >>> store = zarrs_python.v2.DirectoryStore('data/example.zarr')
        >>> g = zarrs_python.v2.group(store=store, overwrite=True)
        >>> g
        <zarrs_python.v2.hierarchy.Group '/'>
...
def open_group(
    ...
    *,
    ...
    --------
    >>> import zarrs_python
    >>> root = zarrs_python.v2.open_group('data/example.zarr', mode='w')
    >>> foo = root.create_group('foo')
    >>> bar = root.create_group('bar')
    >>> root
    <zarrs_python.v2.hierarchy.Group '/'>
    >>> root2 = zarrs_python.v2.open_group('data/example.zarr', mode='a')
    >>> root2
    <zarrs_python.v2.hierarchy.Group '/'>
    >>> root == root2
    True
