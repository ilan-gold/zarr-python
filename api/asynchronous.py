...
from zarrs_python.core.buffer import NDArrayLike
from zarrs_python.core.chunk_key_encodings import ChunkKeyEncoding
from zarrs_python.core.common import JSON, AccessModeLiteral, ChunkCoords, MemoryOrder, ZarrFormat
from zarrs_python.core.group import AsyncGroup
from zarrs_python.core.metadata import ArrayV2Metadata, ArrayV3Metadata
from zarrs_python.store import (
    StoreLike,
    make_store_path,
)
...
async def open(
    ...
    **kwargs
        Additional parameters are passed through to :func:`zarrs_python.creation.open_array` or
        :func:`zarrs_python.hierarchy.open_group`.
...
async def empty(shape: ChunkCoords, **kwargs: Any) -> AsyncArray:
    ...
    **kwargs
        Keyword arguments passed to :func:`zarrs_python.api.asynchronous.create`.
